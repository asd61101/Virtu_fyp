      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-md overflow-hidden">
        <div className="p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 mt-2">Log in to your Virtuspace account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-virtuspace-500 hover:text-virtuspace-600">
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link to="/signup" className="font-medium text-virtuspace-500 hover:text-virtuspace-600">
              Sign up for free
            </Link>
          </p>
        </div>
